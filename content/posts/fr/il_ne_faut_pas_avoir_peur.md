...
Il a été aidé dans son expatriation par des membres de WikiLeaks, plateforme sur laquelle KimDotCom avait démontré [le même genre de magouille en Nouvelle-Zélande.](https://www.splinter.com/kim-dotcom-and-edward-snowden-new-zealand-conducts-mas-1793842456)

Pour en savoir plus, tu peux consulter les sources de [sa page Wikipedia](https://en.wikipedia.org/wiki/Edward_Snowden), ou regarder [Citizenfour](https://en.wikipedia.org/wiki/Citizenfour) (c'est sûrement mieux que la Netflixerie `Snowden`).
...
* [Apple refuse la backdoor, mais désactive la sécurité avancée en Angleterre.](https://www.techradar.com/computing/cyber-security/we-will-never-build-a-backdoor-apple-kills-its-iclouds-end-to-end-encryption-feature-in-the-uk)
* [WhatsApp, déjà exclu du Brésil pour la même raison, est prêt à quitter l'Angleterre](https://www.techmonitor.ai/policy/privacy-and-data-protection/what-if-whatsapp-really-does-leave-the-uk?cf-view)
...
* Si l'Angleterre voulait réellement combattre le crime, [ce genre de chose](https://www.forbes.com/sites/rogerscruton/2014/08/30/why-did-british-police-ignore-pakistani-gangs-raping-rotherham-children-political-correctness/) n'arriverait pas si facilement, et ne me force pas à aller chercher des stats sur la criminalité là-bas. 
...
En Union Européenne, le [même combat](https://www.tf1info.fr/politique/verif-l-union-europeenne-va-t-elle-vraiment-scanner-tous-nos-messages-prives-avec-chat-control-2388955.html) est en cours depuis des années avec "[chat control](https://stopchatcontrol.fr/)" qui permettrait officiellement aux gouvernements, s'il est voté, de jeter un œil à tes conversations, même chiffrées. Cette fois, l'excuse est la lutte contre la pédocriminalité. Je te laisse imaginer un instant le nombre de GIF de gigachads et de "women haha" qu'ils vont devoir éplucher avant de tomber sur du contenu pédo-pornographique... 
...
Si le contenu de tes messages sur Signal ou Whatsapp est techniquement inaccessible pour le ministère de la vérité et de l'amour, ça ne veut pas dire que tu n'y es pas surveillé. [Une grande quantité d'informations, notamment les métadonnées, sont facilement observables.](https://www.techradar.com/computing/cyber-security/whatsapp-encryption-isnt-the-problem-metadata-is) On sait aussi [que depuis longtemps, notre cher gouvernement rechigne à utiliser les mêmes apps que nous autres péons.](https://www.bfmtv.com/tech/whatsapp/cybersecurite-whatsapp-etait-deconseille-a-l-administration-depuis-deux-ans_AV-202312050659.html) Ce ne serait pas assez... sécurisé.

Il est bon de savoir aussi que si votre interlocuteur sur WhatsApp vous signale, [le chiffrement saute et votre conversation sera lue](https://fr.androidguias.com/qu%27est-ce-que-cela-signifie-de-signaler-sur-WhatsApp/).

[Elon Musk nous met en garde face à Signal](https://www.forbes.com/sites/zakdoffman/2024/05/08/elon-musk-fact-checked-on-x-after-surprise-messaging-warning/). Bien qu'il se trompe, - au moment du Tweet, il n'y a effectivement aucune vulnérabilité soutenant son propos - il peut paraître étonnant que Messenger et WhatsApp aient finalement adopté le protocole de messagerie de Signal, ouvert aux audits publics. Difficile de croire qu'ils auraient fait ce sacrifice. 
...
[Une utilisation détournée du loopback sur les appareils Android, permettant de communiquer entre les applications Meta et exploitable par les sites incluant le Pixel de ladite ZuckerCorp.](https://www.theregister.com/2025/06/03/meta_pauses_android_tracking_tech/) Pour se protéger de ça, la solution est de couper la permission `internet` sur Android. 
